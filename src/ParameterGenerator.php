...
{
    public function newPropertyValueGenerator(mixed $value = null, string $type = PropertyValueGenerator::TYPE_AUTO, string $outputMode = PropertyValueGenerator::OUTPUT_MULTIPLE_LINE, null|SplArrayObject|StdlibArrayObject $constants = null): PropertyValueGenerator
    {
